                        ...
                        {homePageProductList.map(product => (
                            <Grid key={product.id} size={{ xs: 12, sm: 6, md: 3 }}>
                                <Box sx={{
                                    ...
                                    <Box component="img" src={product.imgSrc} alt={product.productName} className="hoverEffect" sx={{ display: 'block', filter: 'grayscale(100%)', width: '100%', height: '180px', objectFit: 'cover', 
