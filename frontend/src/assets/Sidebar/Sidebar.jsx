    ...
    return (
        ...
        >
            ...
            <Stack spacing={1} px={2}>
                ...
                <Box key={index} sx={{p:1,color:"#fff", bgcolor: window.location.pathname === menu.url ? "#ac1010ff" : "transparent",
                 borderRadius: 2 , "&:hover": { bgcolor: "#4d4d4d5f" }}} onClick={() => navigate(menu.url, { replace: true })}
                 >
